...
public class ShoppingCart implements java.io.Serializable
{
   ...
   private java.util.List<com.redhat.coolstore.model.ShoppingCartItem> shoppingCartItemList;

   public ShoppingCart()
   {
   }

   public java.util.List<com.redhat.coolstore.model.ShoppingCartItem> getShoppingCartItemList()
   {
      return this.shoppingCartItemList;
   }

   public void setShoppingCartItemList(java.util.List<com.redhat.coolstore.model.ShoppingCartItem> shoppingCartItemList)
   {
   ...
   public ShoppingCart(
         ...
         java.util.List<com.redhat.coolstore.model.ShoppingCartItem> shoppingCartItemList)
   {
      this.cartItemPromoSavings = cartItemPromoSavings;
      this.cartItemTotal = cartItemTotal;
      this.cartTotal = cartTotal;
