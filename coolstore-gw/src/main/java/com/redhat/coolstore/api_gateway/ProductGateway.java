    ...
    public void configure() throws Exception {
        ...
        .get("/").description("Get product catalog").outType(Product.class)
            .route().id("productRoute")
                ...
                .recipientList(simple("https4://{{env:CATALOG_ENDPOINT:catalog:8080}}/api/products")).end()
                .onFallback()
        ...
        from("direct:inventory")
            ...
            .hystrix().id("Inventory Service")
                ...
                .recipientList(simple("https4://{{env:INVENTORY_ENDPOINT:inventory:8080}}/api/availability/${header.itemId}")).end()
            .onFallback()
                //.setHeader(Exchange.HTTP_RESPONSE_CODE, constant(Response.Status.SERVICE_UNAVAILABLE.getStatusCode()))
        ...
        from("direct:rating")
                ...
                .setHeader(Exchange.REST_HTTP_URI, simple("http://{{env:RATING_ENDPOINT:rating:8080}}/api/rating/${header.itemId}"))
